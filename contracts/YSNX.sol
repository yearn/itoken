...
interface ISynthetic {
  ...
  function collateral(address account)
    ...
    function maxIssuableSynths(address issuer, byte32 currencyKey) external view returns (uint256);
}

Synthetix public synthetix;
ISynthetixState public synthetixState;

//49973678846118597 (17)
uint ratio = synthetix.collateralisationRatio(account);
//133333333333333333 (18)
uint targetRatio = synthetixState.issuanceRatio();


contract ySNX is ERC20, ERC20Detailed, ReentrancyGuard, Ownable {
  ...
  constructor () public ERC20Detailed("ySNX", "ySNX", 18) {
